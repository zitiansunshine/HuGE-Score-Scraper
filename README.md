...
`zitiansunshine/huge-scraper:latest` is a Docker-based scraper for extracting **Human Genetic Evidence scores** from the [Common Metabolic Diseases Knowledge Portal (hugeamp.org)](https://hugeamp.org).  
